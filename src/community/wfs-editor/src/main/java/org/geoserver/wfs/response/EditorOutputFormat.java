...
public class EditorOutputFormat extends WFSGetFeatureOutputFormat {
    ...
    // GeoServer version > 2.2.3
//  private GeoJSONGetFeatureResponse jsonFormatter;
...
//      featureType.getGeometryDescriptor().getName().getLocalPart()
     ...
     */
    private String getFeaturesAsJson(FeatureCollectionResponse featureCollection, Operation getFeature)
            throws IOException {
