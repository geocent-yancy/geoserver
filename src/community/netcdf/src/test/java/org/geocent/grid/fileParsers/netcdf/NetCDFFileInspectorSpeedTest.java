...
import org.geocent.log.LogUtil;
import org.geocent.test.TestDataForSpeedTests;
...
/**
 * Unit tests for named class to help analyze operation and speed. These are
 * commented out as they may rely on uncommitted data files and do not need to
 * run on an ongoing basis. I did want to commit these for our future use.
 * 
 * See the documentation in TestDataForSpeedTests.java for configuration
 * information.
 */
public class NetCDFFileInspectorSpeedTest {
    ...
    public void testDoNothing() {
        // Do nothing test so the unit tests don't fail because there are no
        // runnable methods.
    }
    ...
    /**
     * used this to test optimize building the read input parameter. abstracted
     * the original switch statement using String.format() into a method,
     * created other test candidate methods using StringBuffer, tested each
     * using this test method, and based on the results, replaced the original
     * with the speediest.
     */
    // @Test
    ...
    /**
     * used this to test optimize getting the results of the read. three test
     * sub-cases: a. true,true - gets the read output using reduce. b.
     * true,false - gets the read output w/o using reduce. c. false,true - a
     * 'control', does not get the output, just does the read. b. was clearly
     * faster than a. so made the change in the code.
     */
    // @Test
