 ...
 * 
 * set the bounds of the 'simulation' test files and test bounds based on
 * running NetCDFFileInspectorTest testGetBounds methods on the original files
 * being simulated (currently commented out).
 */
public class TestData {
     ...
     * 
     * The data values for each combination are the same between this file and
     * its sister file modelLonOuterLat. This pair of files was created to
     * confirm we get the correct results from our range read independent of the
     * input NetCDF data's lat-lon dim order.
     */
     ...
     * 
     * The data values for each combination are the same between this file and
     * its sister file modelLatOuterLon. This pair of files was created to
     * confirm we get the correct results from our range read independent of the
     * input NetCDF data's lat-lon dim order.
     */
    ...
    /**
     * big file. for test, simulate with file with same bounds and less data.
     * story/defect #artf120060
     */
    // public static final String TEST_DATA_NCOM_REG01 = TEST_DATA_PATH
    // + "ncom_glb_regp01_2012101200.nc";

    /**
     * big file. its data bounding box -150.0, -100.0, 10.0, 65.0. will not
     * write separate unit tests, test to simulate for reg01 will cover.
     * story/defect #artf120060
     * 
     */
    // public static final String TEST_DATA_NCOM_REG07 = TEST_DATA_PATH
    // + "ncom-glb-reg07.nc";

    /**
     * big file. for test, simulate with file with same bounds and less data.
     * story/defect #artf119555
     */
    // public static final String TEST_DATA_SWAN = TEST_DATA_PATH
    // + "SWAN-hawaii_nest1-2006102900.nc";
    ...
    /**
     * test file with tau with time_origin attribute that can be converted to a
     * date.
     */
    ...
    /**
     * test file with tau with time_origin attribute that can not be converted
     * to a date.
     */
    ...
    /**
     * value of the global time_origin attribute of TEST_DATA_ANALYSIS_TIME...
     * files with a global time origin attribute. TODO change this date and redo
     * the files to match so that this date different than the date in the tau
     * var.
     */
    ...
    /**
     * test bounds of TEST_DATA_NCML_SINGLE_RUN_PER_FILE and
     * TEST_DATA_NCML_SINGLE_TAU_PER_FILE files.
     */
